...
"""
Simple positive feedback model
...
class Model:
    def __init__(self, Da, Dp, konA, koffA, konP, koffP, knucP, khillP, kAP, kPA, ePneg, eAneg, xsteps, Tmax,
                 deltat, deltal, am_0, ac_0, pm_0, pc_0):
        # Species
        self.am = am_0
        self.ac = ac_0
        self.pm = pm_0
    ...
    def reactions(self):
        ...
        r[4] = self.konP * self.pc * (self.knucP + (self.pm / (self.khillP + self.pm)))
