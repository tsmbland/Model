...
class Model:
    def __init__(self, Da, Dp, konA, koffA, konP, koffP, kposP, khillP, kAP, kPA, ePneg, eAneg, xsteps, psi, Tmax,
    ...
    def reactions(self):
        ...
        r[8] = self.kposP * self.pc * (self.pm / (self.kposP + self.pm))
