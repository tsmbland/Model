...
class Model:
    ...
    class Res:
        def __init__(self, params):
            self.params = params
            self.scores = {}
            self.am = np.zeros([1, self.params.xsteps])
            self.ac = np.zeros([1])
            self.pm1 = np.zeros([1, self.params.xsteps])
            self.pm2s = np.zeros([1, self.params.xsteps])
            self.pm2d = np.zeros([1, self.params.xsteps])
            self.pc1 = np.zeros([1])
            self.pc2 = np.zeros([1])
