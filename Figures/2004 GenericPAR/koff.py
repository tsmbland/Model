...
datadirec = '/Volumes/lab-goehringn/working/Tom/ModelData/GenericPAR/koff/'
...
# asi_plot(n=5, name='koff_antag_ASI')
...
# dosage_plot(n=0, name='koff_antag_dosage')
...
# trigger_plot(n1=4, n2=6, name='koff_antag_trigger')
...
# pattern_plot([10 ** -3, 10 ** -2.5, 10 ** -2], [], name='koff_patterns')
