...
datadirec = '/Volumes/lab-goehringn/working/Tom/ModelData/ParameterisedPAR/GoehringHD/'
...
asi_plot(n=2, name='Goehring_asi_a')

"""
ASI P

"""
asi_plot(n=3, name='Goehring_asi_p')
...
# dosage_plot(n=5, name='Goehring_dosage_a')
...
# dosage_plot(n=10, name='Goehring_dosage_p')
...
# trigger_plot(n1=0, n2=4, name='Goehring_trigger')
