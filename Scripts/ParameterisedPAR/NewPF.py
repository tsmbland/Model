...
sys.path.append(home_direc + '/../..')
save_direc = home_direc + '/../../../../ModelData/ParameterisedPAR/NewPF/'
...
BaseModel = PAR(Da=0.28, Dp=0.15, konA=0.02115, koffA=0.0092, konP=0.0123, koffP=0.0073, kAP=0, kPA=0, eAneg=0,
                ePneg=0, xsteps=100, psi=0.174, Tmax=10000, deltat=0.01, L=67.3, pA=1.56, pP=1, kposA=0, kposP=0.0336)
...
ParamSpaceQual2D(func, p1_range=[-4, 0], p2_range=[-4, 0], cores=32, resolution0=20, resolution_step=2,
