...
sys.path.append(home_direc + '/../..')
save_direc = home_direc + '/../../../../ModelData/ParameterisedPAR/NewLinear/'
...
BaseModel = PAR(Da=0.28, Dp=0.15, konA=0.02115, koffA=0.0092, konP=0.17, koffP=0.0073, kAP=0, kPA=0, eAneg=0,
                ePneg=0, xsteps=100, psi=0.174, Tmax=10000, deltat=0.01, L=67.3, pA=1.56, pP=1, kposA=0, kposP=0)
