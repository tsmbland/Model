...
sys.path.append(home_direc + '/../..')
save_direc = home_direc + '/../../../../ModelData/ParamSweepGeneralsBistability/'

from Funcs import Bistability
from AdvancedFuncs import ParamSweepGeneral
...
if int(sys.argv[1]) == 1:
    ...
    a = ParamSweepGeneral(b.func, p1_range=(-3, 0), p2_range=(-3, 0), log=True, cores=32, resolution0=100, resolution=2,
                          n_iterations=5, direc=save_direc + '/1')
    a.sweep()
...
if int(sys.argv[1]) == 2:
    ...
    a = ParamSweepGeneral(b.func, p1_range=(-3, 0), p2_range=(-3, 0), log=True, cores=32, resolution0=100,
                          resolution=2, n_iterations=5, direc=save_direc + '/2')
    a.sweep()
...
if int(sys.argv[1]) == 11:
    ...
    a = ParamSweepGeneral(b.func, p1_range=(-4, 0), p2_range=(-4, 0), log=True, cores=32, resolution0=100,
                          resolution=2, n_iterations=5,
                          direc=save_direc + '/11')
    a.sweep()
