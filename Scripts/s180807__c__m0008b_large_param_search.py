...
p0 = m0008b.Params(Da=0.25, kon_a=0.0085, koff_a=0.0054, ra=1, Dp=0.15, kon_p=0.0474, koff_p=0.0073, kon_p_2=0.0474,
                   ...
                   xsteps=500, psi=0.174, Tmax=1000, eqTmax=1000, deltat=0.01, starts=[0, 1.56, 0, 0, 0, 1, 0])
...
x.alg_parsim_clust_duplicate(m=m0008b.Model(p0), changes={'ac_0': 0, 'eqTmax': 0}, oldjobid=11, oldsubjobid=0, newjobid=11,
                             newsubjobid=2,
                             cores=32, node=int(sys.argv[1]), compression=0)
