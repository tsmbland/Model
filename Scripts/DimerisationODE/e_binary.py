...
save_direc = home_direc + '/../../../../ModelData/Dimerisation/e_binary/'
...
kon0/koff = 22.799483171274492 
E = 0.9261655550386308
...
#
#
# ParamSpace2D(func, p1_range=p1_range, p2_range=p2_range, direc='_test3', parallel=False,
#              cores=8, resolution0=5, save_fig=True, n_iterations=1, resolution_step=2, crange=[0, 1],
#              explore_boundaries=True).run()
