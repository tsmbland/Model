...
save_direc = home_direc + '/../../../../ModelData/Dimerisation/kon_binary/'
...
ParamSpace2D(func, p1_range=[-2, 2], p2_range=[-2, 2], direc=save_direc + str(sys.argv[1]), parallel=True,
             cores=32, resolution0=20, save_fig=True, n_iterations=6, resolution_step=2, crange=[0, 1],
             explore_boundaries=True).run()
...
#     m.kd_b = 10 ** kd_b
#
#     # direc = save_direc + str(sys.argv[1]) + '/Saved/' + "{:.12f}".format(kd_f) + '_' + "{:.12f}".format(kd_b) + '/'
...
#
#
# ParamSpace2D(func, p1_range=[-2, 2], p2_range=[-2, 2], direc='_test', parallel=True,
#              cores=8, resolution0=20, save_fig=True, n_iterations=6, resolution_step=2, crange=[0, 1],
#              explore_boundaries=True).run()
