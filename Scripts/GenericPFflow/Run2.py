...
sys.path.append(home_direc + '/../..')
save_direc = home_direc + '/../../../../ModelData/GenericPFflow2HD/'
...
- kant vs flow strength for different E
...
ParamSpaceQual2D(func, p1_range=[-4, 1], p2_range=[0, 0.1], cores=32, resolution0=10, resolution_step=2,
