...
sys.path.append(home_direc + '/../..')
save_direc = home_direc + '/../../../../ModelData/GenericPF/xkon0_linearHD/'
...
Models with linear cross talk

- varying membrane binding non-linearity and strength by toggling kon0 and x
- x vs kon0 for different antagonism rates (0.005, 0.01, 0.025, 0.05, 0.5)
- 5x higher rates than in non-linear model, represents equivalent rates in uniform system
...
kant_vals = [0.005, 0.01, 0.025, 0.05, 0.5]
