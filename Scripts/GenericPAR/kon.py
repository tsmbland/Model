...
sys.path.append(home_direc + '/../..')
save_direc = home_direc + '/../../../../ModelData/GenericPAR/kon/'
...
"""
Exploring the effects of on rate variation
...
ParamSpaceQual2D(func, p1_range=kon_range, p2_range=kant_range, cores=32, resolution0=10, resolution_step=2,
