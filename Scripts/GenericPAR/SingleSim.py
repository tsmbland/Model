...
base_model = Model(Da=0.1, Dp=0.1, konA=0.006, koffA=0.005, kposA=0, konP=0.006,
                   koffP=0.005, kposP=0, kAP=0, kPA=0, ePneg=2, eAneg=2, xsteps=100, Tmax=1000, deltat=0.01, deltax=0.3,
                   psi=0.1, am_0=np.zeros([100]), ac_0=1, pm_0=np.zeros([100]), pc_0=1.02)
