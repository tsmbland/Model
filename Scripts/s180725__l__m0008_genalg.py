...
x.alg_singlesim(m0000.Model(m0000.p0), 9999, 0, 0)
...
x.gen_alg(m=m0008.Model(m0008.p0), func=x.func_genalg_0001, params=params, ranges=ranges, pop=8, gens=1, jobid=6)

x.genalg_plot1(6, [9999, 0, 0])
