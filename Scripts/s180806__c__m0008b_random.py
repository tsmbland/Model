...
ranges = [[0.1, 10], [0.0001, 0.01], [0.1, 10], [0.1, 10], [0.1, 10], [0.01, 1]]

# Standard simulation + analysis
x.alg_parsim_rand_clust(m=m0008b.Model(p0), params=params, ranges=ranges, nsims=4800, jobid=7, subjobid=0, cores=32,
